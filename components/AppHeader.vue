<template>
  <header class="header relative z-20">
    <div class="logo-wrap fixed top-4 left-4 transition duration-300"
      ...
      <a class="
        ...
        <div class="icon block pointer-event-none">
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
            y="0px" height="28" width="28" viewBox="0 0 60 60" style="enable-background: new 0 0 60 60"
            xml:space="preserve">
            <path
    ...
    <nav class="
      ...
      <div class="
            ...
            transform
            scale-90
          " :class="{ 'pointer-events-auto opacity-100 scale-100': scrollOver }" @mouseover="menuOpen = true"
        @mouseleave="menuOpen = false" @click.prevent="menuOpen = true">
      ...
      <div class="site-nav-origin">
        <div class="site-nav-body transition duration-300 relative z-10 px-6" :class="{
          'opacity-0 pointer-events-none': scrollOver,
          'pointer-events-auto opacity-100 delay-200': menuOpen,
          'hover': linkHover
        }">
          <ul class="pb-6" @mouseover="menuOpen = true" @mouseleave="menuOpen = false" @click="menuOpen = false">
            <li class="overflow-hidden">
              <nuxt-link to="/" class="relative">
                <span class="link-text tracking-tight uppercase" @mouseover="linkHover = true"
                  @mouseleave="linkHover = false">Home</span>
                <div class="
                    u
                    left-px
                    origin-right
            ...
            <li v-for="(link, index) in links" :key="index" class="overflow-hidden">
              <nuxt-link :to="'/' + link" class="relative">
                <span class="link-text tracking-tight uppercase" @mouseover="linkHover = true"
                  @mouseleave="linkHover = false">{{ link }}</span>
                <div class="
                    u
                    left-px
                    origin-right
    ...
    <div data-tf-popover="JuzMtES9" data-tf-custom-icon="https://images.typeform.com/images/DhEkLPECvzxe"
      data-tf-button-color="#FFFFFF" data-tf-button-text="Launch me" data-tf-iframe-props="title=VAST Contact Form"
