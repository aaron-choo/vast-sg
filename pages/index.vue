      ...
      >
        ...
        >
          <span
            ...
            >
              <svg
                width="448" height="20" viewBox="0 0 224 10" 
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                id="markerunderline"
      ...
      <div class="relative">
        <div class="scroller-wrapper m-4 grid md:grid-cols-12 gap-4 items-top">
          ...
          <div
            ...
            :style="'--project-color:'+ project.data.textColor + '; --project-bg-color:' + project.data.backgroundColor"
          >
            <nuxt-link :to="LinkGetter(project)">
            <div class="item-overlay hidden absolute top-0 left-0 right-0 bottom-0 md:block z-10 transition duration-300 rounded-lg opacity-0 pointer-events-none">
            </div>
              <p
                class="
                  item-meta
      ...
      <div class="description-section section my-24 px-4 lg:px-40">
        ...
        >
          <span
            ...
            >(Who we are)</span
          ><span
            class="home-description-words inline serif font-light"
            >{{ homedescription }}
          </span>
        </p>
      </div>
